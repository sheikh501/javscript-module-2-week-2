...
let destinationNamesWithin500Kms = [destination1, destination2, destination3, destination4];  // Complete here
...
let destinationNamesMoreThan300KmsAwayByTrain = travelDestinations.filter((destination) => destination.distanceKms > 300 && destination.transportations
.some(transportation => transportation == 'train'))
.map(destination => destination.destinationName);
